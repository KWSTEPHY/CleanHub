          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className={`${cardStyle} bg-yellow-400`}>
                <h2 className="text-4xl font-bold mb-4 text-[#002147]">Our Mission</h2>
                <p className="text-lg">
              ...
              <div className={cardStyle}>
                <h2 className="text-4xl font-bold mb-4 text-[#002147]">Our Vision</h2>
                <p className="text-lg">
              ...
              <h2 className="text-4xl font-bold mb-4 text-[#002147]">Our Values</h2>
              <ul className="text-lg list-disc pl-5">
                <li className="mb-2">
                  Integrity: We operate with honesty and integrity in all that we do.
                </li>
